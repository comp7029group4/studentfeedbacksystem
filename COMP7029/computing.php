...
The SELECT statement is retrieving all the rows and columns from the "computing_and_digital_department" table.
The result of this query is stored in the $result variable for further processing .*/

$result = mysqli_query($con,"SELECT * FROM computing_and_digital_department");
// this echo display the headings of feedback that we fetch from the database
echo "<table border='1'>
<tr>
<th>Module Id</th>

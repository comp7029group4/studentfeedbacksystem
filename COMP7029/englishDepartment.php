...
The SELECT statement is retrieving all the rows and columns from the "english_modern_languagemo" table.
The result of this query is stored in the $result variable for further processing .*/
$result = mysqli_query($con,"SELECT * FROM english_modern_languagemo");

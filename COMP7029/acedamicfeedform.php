...
$q5=$_POST['mood4'];
// This line of code inserts the values of $m1, $q1, $q2, $q3, $q4, and $q5 into the 'computing_and_digital_department' 
// table in the database, using an SQL INSERT statement.
$sql=mysqli_query($conn,"INSERT INTO computing_and_digital_department VALUES ('$m1','$q1','$q2','$q3','$q4','$q5')");
